...
WXTL.Common.help.USERGROUPMOBILEFILE = getHelpMsg("文件", true, "1、文件格式为txt<br>2、文件大小须小于4M<br>3、姓名不得超过5个字符<br>4、内容格式:　<img src=jspack/product/common/Images/help/usergroupmobilefile.jpg align=top/>");
WXTL.Common.help.USERGROUPMOBILELIST = getHelpMsg("号码列表", true, "1、输入行数不超过1000行<br>2、姓名不得超过5个字符<br>3、输入格式:　<img src=jspack/product/common/Images/help/usergroupoldmobilelist.jpg align=Baseline/>");
