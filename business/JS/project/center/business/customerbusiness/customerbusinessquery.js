...
Js.Center.Customer.CustomerBusiness.CustomerBusinessInfo = function(node, row) {
    ...
    if (Ext.get("Js.Center.Customer.CustomerBusiness.CustomerBusinessPanel") == null) {
        ...
        var cusGroupfields = ["numusergroupid", "vc2mobile", "vc2customername", "numtype", "vc2usergroupname", "datcreattime", "vc2username", "vc2departname", "vc2name", "numprodid"];
        //白名单信息

        var whitefields = ["numsvcid", "vc2mobile", "vc2svcname", "datcreatetime", "numprodid", "vc2name", "numsvcid", "vc2svcname", "datinsert"];
        //黑名单信息
            ...
            if (Ext.get("cusbusimobile").getValue() == '') {
                ...
                if (selectPanel.getForm().isValid()) {
                    infostore.baseParams = {
                        ...
                        vc2accountcode: "",
                        proId: Ext.get("userGroupMemberProIdSel").getValue(),
                        flag: flaginfo,
    ...
    items: [ {
		...
		xtype : "xComboBox",
		name : "userGroupMemberProId",
		hiddenName : "userGroupMemberProIdSel",
		...
		store : Js.Center.Common.UserGroupSelectStore
                                            ...
                                            Js.Center.Customer.CustomerBusiness.CustomerBusinessInfo.DeleteCustomerGroup = function(flag, rowIndex) {
                                                ...
                                                var numprodid = row.get("numprodid");
