...
/*******************************************************************************
*YXT-彩信客户组查询
*url：  URL/sendMMS/check/YXTMMScheckquery.ashx
*input: flag(selectsmsclass),mmscontentid(queryusergroupdetailbycontentid)
*method：POST
*output：{success:'true'} or {success:'false'}
********************************************************************************/

Js.Center.SendMMS.YXTMMScheckQueryURL='URL/sendMMS/check/YXTMMScheckquery.ashx';