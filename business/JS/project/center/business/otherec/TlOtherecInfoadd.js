Ext.namespace('Js.Center.Business.OtherEC.OtherEcAdd');
Js.Center.Business.OtherEC.OtherEcAdd.func = function(){
	if(Js.Center.Business.OtherEC.OtherEcAdd.window == null){
	 ...
	 var numbusareaCombox = new WXTL.Widgets.CommonForm.ComboBox({
	    ...
	    var InsertInfofp = new Ext.form.FormPanel({
	    	fileUpload : true,
	        frame: true,
	        labelWidth: 80,
	        defaults: {
	    	...
	    	items: [{
					...
					items : [{
							xtype : "textfield",
							name : "vc2ecid",
							id : "Js.Center.Business.OtherEC.OtherEcAdd.vc2ecid",
		                	...
		                	listeners:{
		                        "blur": function(){
		                        	var ecId = Ext.getCmp("Js.Center.Business.OtherEC.OtherEcAdd.vc2ecid").getValue();
		            	            Ext.Ajax.request({
		            	                ...
		            	                success: function(form, action) {
		            	                    ...
		            	                    if(true == flag){
	            	                    		var fullname = Ext.get("Js.Center.Business.OtherEC.OtherEcAdd.vc2ecfullname");
	            	                    		var shortname = Ext.get("Js.Center.Business.OtherEC.OtherEcAdd.vc2shortname");
	            	                    		fullname.dom.value = "";
	            	                    		shortname.dom.value = "";
		            	                    	if("Y" == objJson.info){
		            	                    		fullname.dom.value = objJson.fullName;
		            	                    		shortname.dom.value = objJson.shortName;
		            	                    		fullname.dom.readOnly = true;
		            	                    		shortname.dom.readOnly = true;
		            	                    	} else {
		            	                    		fullname.dom.readOnly = false;
		            	                    		shortname.dom.readOnly = false;
		            	                    	}
		            	                    }
		            	                },
		            	                failure: function() {
							...
							xtype : "textfield",
							name : "vc2ecfullname",
							id : "Js.Center.Business.OtherEC.OtherEcAdd.vc2ecfullname",
							...
							xtype : "textfield",
							name : "vc2shortname",
							id : "Js.Center.Business.OtherEC.OtherEcAdd.vc2shortname",
	    ...
	    var mainForm = InsertInfofp.getForm();
