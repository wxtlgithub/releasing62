        ...
        items: [{
            ...
            items: [{
                ...
                },  
                {
                    ...
                    xtype: "combo",
                    id: "Js.Center.Popedom.UserUpdate.numnodeid",
                    ...
                    listeners:{
                    	"select":function(){
                    		Ext.getCmp("UserUpdateNumnodeid").setValue(this.getValue());
                    	}
                    }
                },{
	                xtype:"hidden",
	                name:"numnodeid",
	                id:"UserUpdateNumnodeid",
	                value: LOCALNODEID
                }]
            }, {
                columnWidth: .5,
        ...
        listeners:{
        	"show": function(){
    			if(Js.Center.Popedom.UserUpdate.window.updateRecord.data.numtype == 2||
    			 Js.Center.Popedom.UserUpdate.window.updateRecord.data.numtype == 4){
    				Js.Center.Popedom.UserUpdate.window.buttons[2].enable();
    			}
    			else{
    				Js.Center.Popedom.UserUpdate.window.buttons[2].disable();
