...
//            }, {
       ...
       this.window = new WXTL.Widgets.CommonWindows.Window({
            ...
            loadDataStoreFunc: function(){
            	Js.Center.Business.UserGroupMemberDelete.window.items.items[0].items.items[0].getForm().reset();
            	Js.Center.Business.UserGroupMemberDelete.window.items.items[0].items.items[1].getForm().reset();
                Js.Center.Business.UserGroupMemberDelete.window.mainForm.loadRecord(Js.Center.Business.UserGroupMemberDelete.window.updateRecord);
