...
Js.Center.Business.GatewayUpdate.func = function(row){
    ...
    var busareaCombox = new Ext.form.ComboBox({
            ...
            id: 'Js.Center.Business.GatewayUpdate.NumBusArea',
            emptyText: "-=请选择=-",
            allowBlank: false,
            blankText: "请选商务归属",
            fieldLabel: "<font color=red>网关商务归属</font>",
            readOnly: true,
            mode: "local",
        ...
        items: [
        {
                items: [{
                    ...
                    items: [{
	                    ...
	                    fieldLabel: "网关等级",
	                    hiddenName: "vc2level",
                    	id:"Js.Center.Business.GatewayUpdate.vc2level",
	                    readOnly: true,
	                    mode: "local",
	                    displayField: "show",
	                    valueField: "value",
...
//                        })
                    ...
                    items: [new Ext.form.DateField({
                        fieldLabel: '接入时间',
                        name: 'datinput',
                        id: 'Js.Center.Business.GatewayUpdate.DatInput',
                        readOnly: true,
					...
					items : [ {                    	
							name : "vc2oapic",
							id: 'Js.Center.Business.GatewayUpdate.vc2oapic',
							...
							width : 380,
							validator : function() {
								var filePath = Ext.getCmp("Js.Center.Business.GatewayUpdate.vc2oapic").getValue();
...
//            if (Js.Center.Business.GatewayUpdate.window.mainForm) 
//                Js.Center.Business.GatewayUpdate.window.mainForm.reset();
//            
//            Js.Center.Business.GatewayUpdate.window.center();
