...
Js.Center.Business.Program.ProgramInfo = function(node){
    ...
    if (Ext.get("Js.Center.Business.Program.MainPanel") == null) {
        ...
        var fields = ["numclientid", "numlinkprotocolid","vc2linkprotocolname","vc2clientname","numdepartid","vc2departname","vc2username", "vc2password", "vc2clientip", "vc2sublongcode", "nummaxsendspeed", "numclientlevel", "numreturnlevel","moduleid","protocoltype","toexamine"];
        Js.Center.Business.Program.Infostore = new WXTL.Widgets.CommonData.GroupingStore({
            ...
            baseParams: {
                //columnlist: 'numclientid,vc2clientname,vc2username, vc2password, vc2clientip, vc2sublongcode, nummaxsendspeed, numclientlevel, numreturnlevel',
  vc2username: "",
            flag: 'selectbykey'
            }
        });
            ...
            doEdit: function(id){
                ...
                if (row.length == 0) {
                    ...
                    if (row.length > 1) {
                        ...
                        if (row.length == 1) {
                        	Js.Center.Business.ProgramUpdate.window.show();
	                		Js.Center.Business.ProgramUpdate.updateRecord = row[0];
							Js.Center.Business.ProgramUpdate.window.mainForm.loadRecord(row[0]);
							var node = {
									'text' : row[0].data.vc2departname, 
									'id' : row[0].data.numdepartid
							};
