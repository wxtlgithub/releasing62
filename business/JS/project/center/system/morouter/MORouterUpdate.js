...
Js.Center.Business.MORouterUpdate.func = function(row){
	 var SvcCombox = new WXTL.Widgets.CommonForm.ComboBox({                    
        xtype: "xComboBox",
        name: "numsvcid",
        hiddenName: "numsvcid",
	 ...
	 var clientStore = new Ext.data.Store({
		    proxy: new Ext.data.HttpProxy({
		        url: Js.Center.Business.YXTClients,
				method: "POST"
		    }),
    ...
    this.window = new WXTL.Widgets.CommonWindows.Window({
        title: "修改路由",
        mainForm: mainForm,
        updateURL: Js.Center.Business.YXTMORouterUpdateURL,
