...
Js.Center.Business.ProductAdd.func = function(){
	...
	Js.Center.Business.ProductAdd.windowAddSubcode = new Ext.Window({//new WXTL.Widgets.CommonWindows.Window
		...
		buttons:[new Ext.Button({
            ...
            handler: function(){
                ...
                var record = tostroedata.getById(Ext.getCmp("Js.Center.Business.ProductAdd.SubcodeSvcid").getValue());
				...
				record.set("vc2svcname", record.get("vc2svcname1") + "_" + subCode + "   <img src='jspack/product/common/Images/file-add.gif' qtip='添加/修改扩展子号码' onclick='Js.Center.Business.ProductAdd.addSubCode(\""+record.get("numsvcid1")+"\",\""+subCode+"\")'/>" + "<img src='jspack/product/common/Images/file-remove.gif' qtip='删除扩展子号码' onclick='Js.Center.Business.ProductAdd.deleteSubCode(\""+record.get("numsvcid1")+"\")'/>   是否过滤通道敏感词：<img src='" + imageSrc[numdirtytype] + "' qtip='" + imageQtip[numdirtytype] + "' onclick='Js.Center.Business.ProductAdd.filterChange(this, \"" + record.get("numsvcid1") + "\")'/>");
				record.commit();
    ...
    Js.Center.Business.ProductAdd.filterChange = function(img, svcid){
    	var numdirtytype = 0;
		...
		record.set("vc2svcname", record.get("vc2svcname1") + "_" + vc2subcode + "   <img src='jspack/product/common/Images/file-add.gif' qtip='添加/修改扩展子号码' onclick='Js.Center.Business.ProductAdd.addSubCode(\""+record.get("numsvcid1")+"\",\""+vc2subcode+"\")'/>" + "<img src='jspack/product/common/Images/file-remove.gif' qtip='删除扩展子号码' onclick='Js.Center.Business.ProductAdd.deleteSubCode(\""+record.get("numsvcid1")+"\")'/>   是否过滤通道敏感词：<img src='" + img.src + "' qtip='" + imageQtip[numdirtytype] + "' onclick='Js.Center.Business.ProductAdd.filterChange(this, \"" + record.get("numsvcid1") + "\")'/>");
		record.commit();
        Js.Center.Business.ProductAdd.Productspolicy.items.items[0].toMultiselect.view.refresh();
    	Js.Center.Business.ProductAdd.Productspolicy.items.items[0].fromMultiselect.view.refresh();
    	Js.Center.Business.ProductAdd.PreviewProduct();
