...
*method：POST
*output：多条*新增
*VC2VALIDFLAG 开通状态 1商用 0暂停
*NUMPRIFLAG 优先级 0最高 1高 2中 3低
*****************************************************************************/
...
*13、可选ec业务
*
*url：  URL/business/product/productyxt.ashx
*input：
*
...
*vc2opid 运营商编号
*vc2name 运营商名称
*numblackflag 网关类型 1黑名单 2白名单
*vc2subcode 扩子子号
*
*****************************************************************************/
/****************************************************************************
*14、删除业务级联删除通道组对应业务  接扣
*
*url：  URL/business/product/productyxt.ashx
*input：
*
*flag(deleteecproductsservice)
*numecid(ec编号)
*numsvcid 业务编号
*output
*成功删除条数1
...
Js.Center.Business.ProductURL = 'URL/system/product/productsyxt.ashx';
...
/****************************************************************************
*添加、修改 通道组
*url：   URL/business/product/productupdateyxt.ashx
*input：
*
*flag(insert\updateall),
*原有
*vc2servicetype 短彩类型
*vc2name 通道组名称
*vc2dsc 通道组描述
*新增字段
*numecid ec编号
*vc2validflag 状态商用1 暂停0
*numpriflag 优先级 0最高
*usedservice 分配的ec业务 格式："运营商编号1_扩展子号1,运营商编号2_扩展子号1,运营商编号3_"
*longservicecode 长号码
*method：POST
*output：{success:'true'} or {success:'false'}
*****************************************************************************/
...
Js.Center.Business.ProductUpdateURL = 'URL/system/product/productsyxt.ashx';
