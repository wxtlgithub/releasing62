...
Js.Center.Business.Product.productinfo = function(node){
    ...
    if (Ext.get("Js.Center.Business.Product.ProductPanel") == null) {
        ...
        var fields = ["numprodid", "numsvcid", "numbusiid", "numcaid", "vc2prodid", "vc2name", "vc2dsc", "vc2validflag", "datstart", "datend", "numlevel", "vc2type", "numtprodid", "numsrc", "numsrcid", "numstatflag", "numchnid", "numcomflg", "numbwflg", "vc2servcode", "numpriflag", "vc2showname", "numcpid", "vc2sendtype", "numprange", "numuserid", "vc2username", "datcreattime","vc2servicetype","numecid","vc2ecname","vc2subcodeflag"];
...
//                    handler: doPermission
        ...
        Js.Center.Business.Product.queryGrid = function(){
            if (selectPanel.getForm().isValid()) {
                ...
                var _vc2svcname = Ext.get("vc2svcname").getValue();
                var _vc2subcode= Ext.get("vc2subcode").getValue();
                var _numpriflag=Ext.get("numpriflag").getValue();
                var	_vc2validflag=Ext.get("vc2validflag").getValue();
                var _vc2ecname = Ext.get("vc2ecname").getValue();
                ...
                Js.Center.Business.Product.Infostore.baseParams = {
                    ...
                    numpriflag:_numpriflag,
                    vc2validflag:_vc2validflag,
                    vc2ecname:_vc2ecname,
                    vc2subcode:_vc2subcode,
                    flag: flag
                };
                Js.Center.Business.Product.Infostore.load({
                    params: {
