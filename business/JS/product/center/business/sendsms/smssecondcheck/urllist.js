...
/*******************************************************************************
*企业通讯录树
*url：   URL/GJAddressBook/Query.ashx
*input：
*
...
*method：POST
* 
*output：[{“id”:”u用户或d部门编号”,”parentid”:”父部门编号”,”vc2name”:”用户名或部门名”
	,”vc2mobile”:”用户手机号”,”leaf”:”用户true，部门则为false”,”icon”:”区分部门或用户图标”}]
********************************************************************************/
...
*method：POST
* 
*output：{"totalCount":1,"success":true,"error":"","data":[{"numrowasdf":1,
* "NUMUSERGROUPMEMBERID":"成员编号","vc2usergroupmembername":"成员姓名",
* "NUMUSERGROUPID":"客户组编号","vc2usergroupname":"客户组名称","vc2mobile":"手机号"]}
********************************************************************************/
Js.Center.SendSMS.sendbycustomerURL = 'URL/GJAddressBook/Query.ashx';
