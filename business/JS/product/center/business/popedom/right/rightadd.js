...
Ext.namespace('Js.Center.Purview.RightAdd');
Ext.QuickTips.init();
Js.Center.Purview.RightAdd.func = function(){
checkLogin();
Js.Center.Purview.Right.ParentRightStore.reload();
    ...
    // ==================================================================定义FormPanel
    var addRightInfoFormPanel = new Ext.form.FormPanel({
        labelAlign: 'left',
        buttonAlign: 'right',
        frame: true,
        labelWidth: 65,
    ...
    // ======================================================================= 定义窗体
    var mainForm = addRightInfoFormPanel.getForm();
    this.window = new WXTL.Widgets.CommonWindows.Window({
        ...
        items: [addRightInfoFormPanel],
        loadDataStoreFunc: function(){            Js.Center.Purview.Right.ParentRightStore.reload();        }
    });
   // Js.Center.Purview.RightAdd.AddRightInfoWin.show();
};
