...
Js.Center.SendMMS.MMSdepartmoinfo.departmoinfo = function(node){
    ...
    if (Ext.get("Js.Center.SendMMS.MMSdepartmoinfo.MMSDepartMoInfoPanel") == null) {
        ...
        var fields = ["vc2srcmobile", "vc2content", "numsvcid", "datrecv", "vc2username"];
        Js.Center.SendMMS.MMSdepartmoinfo.Infostore = new WXTL.Widgets.CommonData.GroupingStore({
            proxy: new Ext.data.HttpProxy({
                url: Js.Center.SendMMS.MMSMOQueryURL,
                method: "POST"
            }),
        ...
        //            return "<a href='#' onclick='Js.Center.SendMMS.MMSdepartmoinfo.BlackAdd(\"" + record.data.vc2srcmobile + "\")'>加黑</a>";
        //                }
        //        
        //        }
        //        
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [new Ext.form.DateField({
                        ...
                        xtype: "textfield",
                        name: "vc2serviceid",
                        id: "Js.Center.SendMMS.MMSdepartmoinfo.MMSSendServiceID",
                        fieldLabel: "服务号码",
                        regex: /^\d{1,20}$/,
        ...
        Js.Center.SendMMS.MMSdepartmoinfo.queryGrid = function(){
            if (MMSdepartMOinfoselectPanel.getForm().isValid()) {
                ...
                var numsvcid = Ext.get("Js.Center.SendMMS.MMSdepartmoinfo.MMSSendServiceID").getValue();
