        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
					...
					id:'Js.Center.SendMMS.MMSsendUpdate.UploadLargeFile',
					fieldlableFile:getHelpMsg("文件", true, "1、文件格式为txt<br>2、客户端文件请选择小于4M的文件；<br>3、内容格式:　<img src=jspack/product/common/Images/help/mobilefile.jpg align=top/>"),
					needLargfile:false
					
//                    xtype: 'fileuploadfield',
//                    id: 'Js.Center.SendMMS.MMSsendUpdate.SMSmobilefile',
...
//                    width: 400,
//                    validator: function(){
//                        var filePath = Js.Center.SendMMS.MMSsendUpdate.MMSSendListPanel.getForm().items.items[5].getValue();
//                        
//						if (filePath != '') {
//                            Js.Center.SendMMS.MMSsendUpdate.MMSSendListPanel.getForm().items.items[6].el.dom.value = getFileMessage(filePath);
...
//                    xtype: 'textarea',
//                    name: 'filemessage',
//                    id: 'Js.Center.SendMMS.MMSsendUpdate.SMSfilemessage',
//                    fieldLabel: '文件信息',
//                    readOnly: true,
//                    disabled: true,
//                    width: 400,
