    ...
    if (Ext.get("Js.Center.Business.WhitelistAdd.MainPanel") == null) {
        ...
        Js.Center.Business.WhitelistAdd.Infostore = new WXTL.Widgets.CommonData.GroupingStore({
            ...
            reader: new Ext.data.JsonReader({
                fields: ["numsvcid", "vc2backuppath", "vc2mode", "numdepartid", "numlogid", "numuserid", "datcreattime", "datmodifytime", "numtotalnum", "numsuccessnum", "numfailed","vc2filename", "numlisttype", "numsrc", "vc2username", "vc2departname", "numstate", "vc2svcname"],
                root: "data",
                id: "numlogid",
                            ...
                            items: [{
                                ...
                                Js.Center.Business.WhitelistAdd.queryGrid = function() {
                                    if (selectPanel.getForm().isValid()) {
                                        ...
                                        //var vc2UserName = Ext.get("whitelistaddvc2username").getValue();
                                        var flag = 'selectlog';
